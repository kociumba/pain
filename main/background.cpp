...
std::tuple<GLuint, GLuint, GLuint> make_opengl_program() {
...
void main() {
    ...
    glNamedBufferStorage(vertexBuffer, 3 * sizeof(glm::vec3), vertices.data(), 0);
    ...
    return {shaderProgram, vertexArrayObject, vertexBuffer};
}
